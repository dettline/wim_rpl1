      ...
      <div class="container-fluid container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($_SESSION['menu']=="Sepeda") { echo "active"; } ?>" href="<?= base_url; ?>sepeda/show_sepeda.php"><i class="bi bi-bicycle"></i> Sepeda</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($_SESSION['menu']=="Dealer") { echo "active"; } ?>" href="<?= base_url; ?>dealer/show_dealer.php"><i class="bi bi-houses-fill"></i> Dealer</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($_SESSION['menu']=="Inventori") { echo "active"; } ?>" href="<?= base_url; ?>inventori/show_inventori.php"><i class="bi bi-box-seam-fill"></i> Inventori</a>
            </li>
          </ul>
